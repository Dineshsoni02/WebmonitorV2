...
const DialogBox = () => {
  return (
    <div className="max-w-sm p-8 mx-auto fixed inset-0 z-50 bg-gradient-to-r from-gray-900/95 to-gray-800/95 backdrop-blur-md border-b border-gray-700/50 text-white rounded-xl my-[15%] h-fit">
      <div className="flex items-center gap-2 mb-4">
      ...
      <form className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          <label htmlFor="url" className="text-white">Enter Website URL *</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="name" className="text-white">Enter Website Name *</label>
          <input
            type="text"
