...
const Modal = (props) => {
  return (
    <div className="modal fixed inset-0 z-50 bg-black/80 flex items-center justify-center">
      <div className="modal_content bg-gradient-to-r from-gray-900/95 to-gray-800/95 backdrop-blur-md border-b border-gray-700/50 text-white rounded-xl my-[15%] h-fit max-w-sm w-full">
        {props.children}
      </div>
    </div>
  );
  ...
  return (
    <Modal>
      <div className=" p-8 mx-auto relative w-full">
        ...
        <button className=" text-white  rounded-lg font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-lg  cursor-pointer absolute top-2 right-2">
          <X className="w-6 h-6" />
        </button>
